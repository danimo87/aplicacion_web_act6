...
export class UsuariosService {
  ...
  async crear(datosUsuario: Partial<Usuario>): Promise<Omit<Usuario, 'password'>> {
    ...
    const creado = await this.usuariosRepository.save(nuevoUsuario);
    const { password, ...sinPassword } = creado as Usuario;
    return sinPassword;
  }
